...
">
            ...
            {features.map((feature, index) => {
              const stairClasses = [
                "lg:row-span-2 lg:translate-y-0",
                "lg:row-span-2 lg:translate-y-12",
                "lg:row-span-2 lg:translate-y-24",
                "lg:row-span-2 lg:translate-y-36",
              ];
          ...
          "
                  >
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 via-purple-500/30 to-pink-500/30 blur-xl" />
                    </div>

                    <CardContent className="text-center relative z-10 p-6 flex flex-col items-center gap-2">
                      <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:bg-primary/20 transition-colors">
                        {feature.icon}
                      </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <Link href="/dashboard" passHref>
              <Button
                ...
                Take the first step today<ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          </div>
